                        ...
                        <Modal
                            ...
                            body={
                                <div className="flex flex-col gap-4">
                                    ...
                                    {/*Şehir ve İlçe seçeneklerini buraya ekle  select ve option kullanarak */}
                                    <CitySelect data={countriesData}/>
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Typography color="gray" className="mt-4 text-center font-normal">
                                            ...
                                            <button
                                                // onClick= close register modal and open login modal
                            ...
                            body={
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Typography color="gray" className="mt-4 text-center font-normal">
                                            {/*        if user have not an accout create account direction */}
                                            Don't have an account?
                                            <button
                                                // onClick= close login modal and open register modal
                                                className="font-medium text-gray-900">
                                                {" "} <b>Sign Up</b> {" "}
                                            </button>
