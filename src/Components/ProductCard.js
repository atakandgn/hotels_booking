...
export default function ProductCard() {
    ...
    return (
        <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-12 my-6">
            {
                hotelData ? (
                    hotelData.hotels.map((product, index) => {
                            return (
                             <div className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                                 <Badge color="teal" content={"%" + product.hotel_discount + " OFF"}
                                        className="sm:mr-4 mr-6 bolder">
